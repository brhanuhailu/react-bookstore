...
- [📖 React Book Store](#about-project)
...
**[React Book Store]** is a Single page application. It is the second phase to setup redux and action. It is developed using React Library. It allows users to add new book, edit book, remove book and to manage their statuse on the book reading progress. 
...
```sh
  cd my-folder
  git https://github.com/brhanuhailu/react-bookstore.git
```
...
Feel free to check the [issues page](https://github.com/brhanuhailu/react-bookstore/issues).
...
This project is [MIT](https://github.com/brhanuhailu/react-bookstore/blob/dev/LICENSE) licensed.
